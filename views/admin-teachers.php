                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1 flex justify-between">
                        ...
                        <?php foreach(range(1, $pagesNum) as $n): ?>
                            <a href="/admin/teachers?page=<?=$n?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"><?=$n?></a>
                        <?php endforeach?>
                        </ul>
