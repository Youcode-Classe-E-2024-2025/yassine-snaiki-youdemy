...
<body class="bg-gray-100">
    <div class="min-h-screen flex">
        ...
        <div id="sidebar"
            class="bg-blue-800 text-white w-64 py-6 flex flex-col fixed h-full transition-transform duration-300 ease-in-out z-20">
            ...
            <nav class="flex-1 flex flex-col pt-6">
                <a href="/"
                    class="block px-6 py-3 hover:bg-blue-700 <?= $_SERVER['REQUEST_URI'] === '/' ? 'bg-blue-700' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 inline-block mr-3">
                ...
                <a href="/courses"
                    class="block px-6 py-3 hover:bg-blue-700 <?= strpos($_SERVER['REQUEST_URI'], '/courses') !== false ? 'bg-blue-700' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 inline-block mr-3">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="/mycourses"
                    class="block px-6 py-3 hover:bg-blue-700 <?= strpos($_SERVER['REQUEST_URI'], '/mycourses') !== false ? 'bg-blue-700' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 inline-block mr-3">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="px-6 py-4 border-t border-blue-700">
                <div class="flex items-center">
                    <img src="https://ui-avatars.com/api/?name=<?= $_SESSION['user']['username'] ?>&background=random"
                        alt="<?= $_SESSION['user']['username'] ?>" class="w-8 h-8 rounded-full mr-3">
                    <div>
            ...
            <header class="bg-white shadow">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <a href="/" class="text-2xl font-bold text-gray-800"><span
                                class=" text-blue-500">You</span>demy</a>
                    </div>
