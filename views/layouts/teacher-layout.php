...
<body class="bg-gray-100">
    <div class="min-h-screen flex">
        <!-- Sidebar -->
        <div id="sidebar"
            class="bg-indigo-800 text-white w-64 py-6 flex flex-col fixed h-full transition-all duration-300 ease-in-out z-20">
            ...
            <nav class="flex-1">
                ...
                <a href="/teacher/courses/create"
                    class="block px-6 py-3 hover:bg-indigo-700 <?= strpos($_SERVER['REQUEST_URI'], '/teacher/courses/create') !== false ? 'bg-indigo-700' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block mr-3">
                ...
                <a href="/teacher/students"
                    class="block px-6 py-3 hover:bg-indigo-700 <?= strpos($_SERVER['REQUEST_URI'], '/teacher/students') !== false ? 'bg-indigo-700' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block mr-3">
                ...
                <a href="/teacher/statistics"
                    class="block px-6 py-3 hover:bg-indigo-700 <?= strpos($_SERVER['REQUEST_URI'], '/teacher/statistics') !== false ? 'bg-indigo-700' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block mr-3">
            ...
            <header class="bg-white shadow">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-gray-800">Teacher Dashboard</h2>
                    </div>
