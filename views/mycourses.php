                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex justify-end">
                            <a href="/study/course?id=<?=$course->getId()?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                               Study Course
                            </a>
                        </div>
                    </div>
